...
class LocalePlaceFacture extends StatefulWidget {
  final LocaleSponsoringData data;
  final String userId;

  LocalePlaceFacture({required this.data, required this.userId});

  @override
  State<LocalePlaceFacture> createState() => _LocalePlaceFactureState();
}

class _LocalePlaceFactureState extends State<LocalePlaceFacture> {
  String firstname = "";
  String lastname = "";
                ...
                children: [
                  ...
                  Table(
                    ...
                    children: [
                      ...
                      _buildTableRow(
                          'Mobile Number:', widget.data.mobileNumber),
                      ...
                      _buildTableRow('Place Type:', widget.data.placetype),
                      _buildTableRow('Place Name:', widget.data.placeName),
            ...
            TextButton(
              onPressed: () {
                ...
                FirebaseFirestore.instance.collection('sponsoring').add({
                  ...
                  'placetype': widget.data.placetype,
