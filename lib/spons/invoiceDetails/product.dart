...
class Product extends StatefulWidget {
  ...
  Product({required this.factureId});
                ...
                children: [
                  ...
                  Table(
                    ...
                    children: [
                      ...
                      _buildTableRow('Locale Type', factureData!['localeType']),
                      _buildTableRow('Product', factureData!['product']),
                      _buildTableRow('Maker', factureData!['maker']),
                      _buildTableRow('Price', factureData!['price'].toString()),
                      _buildTableRow(
                          'Description', factureData!['description']),
                      _buildTableRow(
                          'Budget', factureData!['budget'].toString()),
                    ],
                  ),
                  SizedBox(height: 20),
                  Center(
